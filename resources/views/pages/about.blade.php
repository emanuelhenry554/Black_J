    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        <div class="relative">
            <div class="aspect-[3/4] bg-surface-container overflow-hidden shadow-luxury">
                <img src="https://images.unsplash.com/photo-1547949003-9796a3938976?q=80&w=1000&auto=format&fit=crop" alt="Atelier Blac Joyaux" class="w-full h-full object-cover">
            </div>
